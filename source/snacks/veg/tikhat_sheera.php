...
<br>
<figure>
<img src="tikhat_sheera.jpg" />
<figcaption>Tikhat Sheera (Sanja)</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.30</figcaption>
</figure><br>
<button name="item_name" value="tikhat_sheera">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Similar to 'Upit'. A thick porridge made from semolina perked up with green chillies, onions and other spices.
</div>
</body>
</form>
</html>