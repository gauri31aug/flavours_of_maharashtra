...
<br>
<figure>
<img src="god_sheera.jpg" />
<figcaption>God Sheera</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.50</figcaption>
</figure><br>
<button name="item_name" value="god_sheera">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Sweet dish that can be eaten as breakfast or as a side dish with lunch/dinner. The classical ingredients used for its preparation are semolina, sugar, ghee (usually), water and milk.
</div>
</form>
</body>
</html>