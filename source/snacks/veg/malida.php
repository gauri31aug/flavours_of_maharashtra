...
<button name="item_name" value="malida">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">One of the most common and healthy breakfast dish made from chapatis/rotis. Flavoured with mustard seeds, onion, curry leaves and green chillies.
</div>
</form>
</body>
</html>