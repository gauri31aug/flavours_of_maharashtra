...
<button name="item_name" value="upit">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Common Maharashtrian breakfast dish, cooked as a thick porridge from dry roasted semolina. Added  with various seasonings and/or vegetables. Usually enjoyed warm.
</div>
</form>
</body>
</html>