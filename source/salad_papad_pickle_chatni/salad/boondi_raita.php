...
<br>
<figure>
<img src="boondi_raita.jpg" />
<figcaption>Bundi Raita</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.30</figcaption>
</figure><br>
<button name="item_name" value="boondi_raita">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Chickpea flour dropped into droplets and deep fried and added to curd. Salt and red chilli powder added for taste, tempered with cumin and mustard seeds, green chillies, curry leaves, asafoetida garnished with coriander leaves. Awesome combination with rice dishes!
</div>
</form>
</body>
</html>