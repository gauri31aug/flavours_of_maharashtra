...
<br>
<figure>
<img src="lal_bhopla.jpg" />
<figcaption>Lal Bhopla Raita</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.30</figcaption>
</figure><br>
<button name="item_name" value="lal_bhopla">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Pumpkin pieces boiled and tempered with cumin and mustard seeds, green chillies, curry leaves, asafoetida, garnished with coriander leaves added with curd. Sugar and salt added for taste. Awesome combination with rice dishes!
</div>
</form>
</body>
</html>