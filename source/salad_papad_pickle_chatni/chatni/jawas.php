...
<button name="item_name" value="jawas">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Flax seeds are popularly known as "Jawas" in Maharashtra and "Alsi" in Hindi. Owing to the high presence of essential nutrients, omega 3 fatty acids, dietary fibers and lignan it has been attributed with the tag of superfood. Jawas Chatni is a very popular rustic Maharashtrian dish that makes for a delicious accompaniment with Bhakri or Chapati. Flax seeds are dry roasted in a pan until it releases a nutty aroma and a visible change in color of seeds, then combined with garlic, salt and red chilli powder for the extra zing.
</div>
</form>
</body>
</html>