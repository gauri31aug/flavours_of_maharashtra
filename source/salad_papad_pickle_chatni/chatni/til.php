...
<button name="item_name" value="til">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Seasame seeds dry roasted, ground with red chillies and garlic. Salt added to taste. A very traditional, tasty and nutritious side dish with Bhakri and chapatis.
</div>
</form>
</body>
</html>