...
<br>
<figure>
<img src="mirchi_thecha.jpg" />
<figcaption>Mirchi Thecha</figcaption>
<figcaption>1 tsp</figcaption>
<figcaption>Rs.10</figcaption>
</figure><br>
<button name="item_name" value="mirchi_thecha">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Green chillies roasted in oil thoroughly grinded with raw garlic and peanuts often. Salt added to taste. A very traditional and spicy but tasty recipe that combines with Bhakris or chapatis.
</div>
</form>
</body>
</html>