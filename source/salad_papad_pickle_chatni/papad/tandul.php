...
<button name="item_name" value="tandul">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Speciality of the Konkan region of Maharashtra. Rice flour mixed with water, cumin seeds and traditional salt and steamed to form a soft dough, later rolled flat into small round like rotis and dried in sun. Deep fried to form crunchy 'Tandalache papad'. A healthy and traditional filler for veg recipes.
</div>
</form>
</body>
</html>