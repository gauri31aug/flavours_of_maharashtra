...
<button name="item_name" value="poha">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Speciality of the Konkan region of Maharashtra. Flattened rice flour mixed with water, black pepper powder, red chilli powder and traditional salt and steamed to form a soft dough, later rolled flat into small round like rotis and cut into square pieces, dried in sun. Deep fried to form crunchy 'Poha papad' also called as 'Mirgunda'. A healthy and traditional filler for veg dishes.
</div>
</form>
</body>
</html>