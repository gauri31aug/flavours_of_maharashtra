...
<button name="item_name" value="kajugar">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Dry grated coconut, onions, traditional spices, coriander, ginger, garlic grinded together to make a spicy gravy tempered with curry leaves, cumin and mustard seeds. Fresh cashew nuts added as main stuff. A healthy and tasty recipe.
</div>
</form>
</body>
</html>