...
<br>
<figure>
<img src="kala_watana.jpg" />
<figcaption>Kala Watanyachi Usal</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.35</figcaption>
</figure><br>
<button name="item_name" value="kala_watana">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Dry grated coconut, onions, traditional spices, coriander, ginger, garlic grinded together to make a spicy gravy tempered with curry leaves, cumin and mustard seeds. Sprouted black peas added as main stuff. A healthy and tasty recipe.
</div>
</form>
</body>
</html>