...
<br>
<figure>
<img src="tondli_bhaat.jpg" />
<figcaption>Tondli Bhaat</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.35</figcaption>
</figure><br>
<button name="item_name" value="tondli_bhaat">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Normal short rice cooked by adding vertically chopped Ivy gourd, traditional spices, ginger garlic paste, salt and turmeric. Garnished with coriander leaves. Tastes best along with any type of curd salad with a dollop of ghee over.
</div>
</form>
</body>
</html>