...
<br>
<figure>
<img src="veg_pulao.jpg" />
<figcaption>Veg Pulao</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.35</figcaption>
</figure><br>
<button name="item_name" value="veg_pulao">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Long rice cooked by adding various seasonings such as cauliflower, carrot, green peas, beans, tomatoes, traditional spices and salt. Cooked on special occassions. Garnished with coriander leaves. Tastes best along with any type of curd salad.
</div>
</form>
</body>
</html>