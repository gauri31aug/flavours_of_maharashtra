...
<br>
<figure>
<img src="masala_khichadi.jpg" />
<figcaption>Masala Khichadi</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.35</figcaption>
</figure><br>
<button name="item_name" value="masala_khichadi">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Normal short rice and cover less green gram pressure cooked together, but before that tempered with chopped onions, traditional spices, garlic nand curry leaves. Salt and sugar added for taste. Tastes best when hot with a dollop of ghee over and lemon juice.
</div>
</form>
</body>
</html>