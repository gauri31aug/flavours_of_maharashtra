...
<br>
<figure>
<img src="masale_bhaat.jpg" />
<figcaption>Masale Bhaat</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.35</figcaption>
</figure><br>
<button name="item_name" value="masale_bhaat">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Normal short rice cooked by adding various seasonings such as vertically chopped onions, cauliflower, carrot, green peas, tomatoes, traditional spices, ginger garlic paste, salt and turmeric. Cooked on special occassions. Garnished with fresh grated coconut and coriander leaves. Tastes best along with any type of curd salad with a dollop of ghee over.
</div>
</form>
</body>
</html>