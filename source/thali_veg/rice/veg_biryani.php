...
<button name="item_name" value="veg_biryani">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Long rice cooked by adding various seasonings such as vertically chopped onions, cauliflower, carrot, green peas, tomatoes, potatoes, traditional spices, ginger garlic paste, salt, curd, lemon juice and turmeric. Cooked on special occassions. Garnished with deep fried crispy chopped onion and coriander leaves. Tastes best along with any type of curd salad.
</div>
</form>
</body>
</html>