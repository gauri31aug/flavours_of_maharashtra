...
<html>
<head>
<title>tomato_batata_rassa</title>
...
<br>
<figure>
<img src="tomato_batata_rassa.jpg" />
<figcaption>Tomato Batata Rassa</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.35</figcaption>
</figure><br>
<button name="item_name" value="tomato_batata_rassa">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Potatoes and tomatoes tempered with chopped onion, cumin and mustard seeds, green chillies, turmeric, salt and traditional spices to make a semi curry garnished with fresh grated coconut and coriander leaves.
</div>
</form>
</body>
</html>