...
<button name="item_name" value="kobi">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Chopped cabbage cooked by tempering green chillies, cumin and mustard seeds, asafoetida, turmeric and salt garnished with fresh grated coconut and coriander leaves.
</div>
</form>
</body>
</html>