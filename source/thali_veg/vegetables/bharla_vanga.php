...
<br>
<figure>
<img src="bharla_vanga.jpg" />
<figcaption>Bharla Vanga</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.35</figcaption>
</figure><br>
<button name="item_name" value="bharla_vanga">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Eggplant/brinjal stuffed with a fried mixture of onion, dry grated coconut, garlic, coriander, crushed peanuts and traditional spices steamed till soft. Awesome combination for all Indian breads.
</div>
</form>
</body>
</html>