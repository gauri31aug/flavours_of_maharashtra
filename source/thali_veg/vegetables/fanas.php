...
<button name="item_name" value="fanas">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Raw jackfruit pieces boiled and smashed and tempered with chopped onion, cumin and mustard seeds, garnished with coriander and fresh grated coconut. Black seasame seeds crush added for taste.
</div>
</form>
</body>
</html>