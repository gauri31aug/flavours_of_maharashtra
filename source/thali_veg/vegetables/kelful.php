...
<button name="item_name" value="kelful">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Flower of banana plant (properly cleaned by removing the unwanted part) cooked by tempering onion, garlic, green chillies and traditional spices garnished with fresh grated coconut and coriander leaves.
</div>
</form>
</body>
</html>