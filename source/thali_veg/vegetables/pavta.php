...
<button name="item_name" value="pavta">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Lima beans cooked with a fried mixture of onion, dry grated coconut, garlic, ginger, coriander and traditional spices to make a semi gravy.
</div>
</form>
</body>
</html>