...
<html>
<head>
<title>vanga_batata_pavta</title>
...
<br>
<figure>
<img src="vanga_batata_pavta.jpg" />
<figcaption>Vanga Batata Pavta Rassa</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.35</figcaption>
</figure><br>
<button name="item_name" value="vanga_batata_pavta">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">A mixed veg speciality cooked with brinjals, potatoes, drumsticks, tomatoes, lima beans tempered with chopped onion, cumin and mustard seeds, green chillies, turmeric, salt and traditional spices to make a semi curry garnished with fresh grated coconut and coriander leaves.
</div>
</form>
</body>
</html>