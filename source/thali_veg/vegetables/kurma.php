...
<button name="item_name" value="kurma">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Mix veg speciality cooked with cauliflower, tomatoes, potatoes, carrot, green peas, onions, ginger-garlic paste and traditional spices garnished with fresh grated coconut and coriander leaves.
</div>
</form>
</body>
</html>