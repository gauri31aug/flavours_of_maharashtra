...
<button name="item_name" value="athla">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Boiled jackfruit seeds are peeled off cute into pieces tempered with chopped onion, cumin and mustard seeds, green chillies and traditional spices garnished with fresh grated coconut and coriander leaves.
</div>
</form>
</body>
</html>