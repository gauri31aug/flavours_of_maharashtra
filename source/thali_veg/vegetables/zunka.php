...
<button name="item_name" value="zunka">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Chickpeas flour mixed with water tempered with chopped onion, cumin and mustard seeds, green chillies, turmeric, salt and traditional spices cooked until dry. A very traditional and tasty recipe usually eaten in villages of Maharashtra.
</div>
</form>
</body>
</html>