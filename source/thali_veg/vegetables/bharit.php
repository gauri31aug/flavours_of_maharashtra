...
<button name="item_name" value="bharit">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Eggplant/brinjal roasted on flames, peeled off, crushed added with raw chopped onion, green chillies, coriander and salt. Very traditional and tasty dish usually eaten with Indian rotis- Bhakris.
</div>
</form>
</body>
</html>