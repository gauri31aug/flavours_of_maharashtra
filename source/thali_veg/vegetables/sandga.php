...
<button name="item_name" value="sandga">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">A flavoured recipe made from dried droplets of green gram and chickpea flour called "sandga". Green gram and chickpeas soaked and grinded together mixed with green chillies- garlic paste, coriander leaves, cumin seeds, salt and turmeric which is then dropped into small droplets and dried in sun. These are then tempered with chopped onion, cumin and mustard seeds green chillies, turmeric, salt and traditional spices garnished with coriander leaves.
</div>
</form>
</body>
</html>