...
<br>
<figure>
<img src="solbatata.jpg" />
<figcaption>Solbatata</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.35</figcaption>
</figure><br>
<button name="item_name" value="solbatata">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Boiled potato cut into pieces tempered with chopped onion, cumin and mustard seeds, green chillies, turmeric, salt and traditional spices garnished with fresh grated coconut and coriander leaves.
</div>
</form>
</body>
</html>