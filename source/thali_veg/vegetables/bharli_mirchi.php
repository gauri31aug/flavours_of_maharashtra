...
<br>
<figure>
<img src="bharli_mirchi.jpg" />
<figcaption>Bharli Mirchi</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.35</figcaption>
</figure><br>
<button name="item_name" value="bharli_mirchi">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Long Capsicum stuffed with a fried mixture of onion, dry grated coconut, garlic, coriander, jaggery and traditional spices steamed till soft. Awesome combination for all Indian breads.
</div>
</form>
</body>
</html>