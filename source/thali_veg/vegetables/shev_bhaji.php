...
<br>
<figure>
<img src="shev_bhaji.jpg" />
<figcaption>Shevechi Bhaji</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.35</figcaption>
</figure><br>
<button name="item_name" value="shev_bhaji">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Crispy chickpea noodles cooked with a fried mixture of onion, dry grated coconut, garlic, ginger, coriander and traditional spices to make a semi gravy. A traditional tasty recipe.
</div>
</form>
</body>
</html>