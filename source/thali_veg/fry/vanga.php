...
<button name="item_name" value="vanga">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Sliced egg plant/brinjal coated with rice flour, semolina, red chilli powder, turmeric and salt shallow fried to make a crispy tasty add on.
</div>
</form>
</body>
</html>