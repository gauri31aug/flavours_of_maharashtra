...
<button name="item_name" value="methi">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Finely chopped fenugreek leaves cooked by adding onions, garlic, green chillies, salt and garnished with fresh grated coconut. A healthy and tasty recipe.
</div>
</form>
</body>
</html>