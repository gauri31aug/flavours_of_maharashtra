...
<br>
<figure>
<img src="palak_gravy.jpg" />
<figcaption>Palakchi Pattal Bhaji</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.35</figcaption>
</figure><br>
<button name="item_name" value="palak_gravy">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Finely chopped spinach leaves mixed with gram flour, salt, green chillies/red chilli powder, ginger-garlic paste and crushed peanuts cooked with water till it becomes a soft gravy. A healthy and tasty recipe.
</div>
</form>
</body>
</html>