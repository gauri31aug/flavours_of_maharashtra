...
<br>
<figure>
<img src="tomato_sambar.jpg" />
<figcaption>Tomato Sambar</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.20</figcaption>
</figure><br>
<button name="item_name" value="tomato_sambar">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Fresh grated coconut, traditional spices, coriander, garlic and tomatoes grinded together to make a medium gravy tempered with curry leaves, cumin and mustard seeds. Dried fruit of garnicia indica added for flavour. Tastes awesome with steamed rice.
</div>
</form>
</body>
</html>