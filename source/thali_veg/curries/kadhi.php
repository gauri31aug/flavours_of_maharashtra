...
<button name="item_name" value="kadhi">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">A sweet, sour and spicy curry made from buttermilk and gram flour, tempered with curry leaves, cumin and mustard seeds, garlic and  green chillies. Salt and sugar added for taste.
</div>
</form>
</body>
</html>