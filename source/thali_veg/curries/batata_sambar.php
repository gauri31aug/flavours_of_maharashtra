...
<br>
<figure>
<img src="batata_sambar.jpg" />
<figcaption>Batata Sambar</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.20</figcaption>
</figure><br>
<button name="item_name" value="batata_sambar">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Fresh grated coconut, onions, traditional spices, coriander, ginger, garlic grinded together to make a medium gravy tempered with curry leaves, cumin and mustard seeds. Potatoes added as main stuff. Eaten with steamed rice or even Indian breads.
</div>
</form>
</body>
</html>