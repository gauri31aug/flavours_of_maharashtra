...
<br>
<figure>
<img src="godi_amti.jpg" />
<figcaption>Godi Amti</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.20</figcaption>
</figure><br>
<button name="item_name" value="godi_amti">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">A spicy, sweet, sour curry made from pressure cooked pigeon peas tempered with traditional spices, curry leaves, cumin and mustard seeds, tamarind and jaggery added for flavour.
</div>
</form>
</body>
</html>