...
<br>
<figure>
<img src="chanyachi_amti.jpg" />
<figcaption>Chanyachi Amti</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.20</figcaption>
</figure><br>
<button name="item_name" value="chanyachi_amti">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Dry grated coconut, onions, traditional spices, coriander, ginger, garlic grinded together to make a spicy curry tempered with curry leaves, cumin and mustard seeds. Sprouted bengal grams added as main stuff.
</div>
</form>
</body>
</html>