...
<br>
<figure>
<img src="pivli_amti.jpg" />
<figcaption>Pivli Amti</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.20</figcaption>
</figure><br>
<button name="item_name" value="pivli_amti">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">A simple curry made from pressure cooked pigeon peas tempered with curry leaves, green chillies, garlic, cumin and mustard seeds garnished with fresh grated coconut and coriander leaves.
</div>
</form>
</body>
</html>