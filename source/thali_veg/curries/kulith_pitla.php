...
<br>
<figure>
<img src="kulith_pitla.jpg" />
<figcaption>Kulthacha Pithla</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.20</figcaption>
</figure><br>
<button name="item_name" value="kulith_pitla">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Curry prepared from the horsegram flour. Horsegram flour mixed with water tempered with garlic, onions, green chillies and traditional spices garnishedn with coriander leaves.
</div>
</form>
</body>
</html>