...
<br>
<figure>
<img src="katachi_amti.jpg" />
<figcaption>Katachi Amti</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.20</figcaption>
</figure><br>
<button name="item_name" value="katachi_amti">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Dry grated coconut, onions, traditional spices, coriander, ginger, garlic grinded together to make a spicy curry, tempered with curry leaves, cumin and mustard seeds. chickpea stock added as main stuff.
</div>
</form>
</body>
</html>