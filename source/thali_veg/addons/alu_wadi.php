...
<br>
<figure>
<img src="alu_wadi.jpg" />
<figcaption>Alu Wadi</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.40</figcaption>
</figure><br>
<button name="item_name" value="alu_wadi">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Thick mixture of chickpea flour, grated onions, tamarind juice, jaggery, red chilli powder, turmeric, some oil, salt and coriander is applied between colocasia leaves to form layers, further rolled into a roll and steamed. The roll is cut into thin slices and deep fried till crispy. Tastes best when hot.
</div>
</form>
</body>
</html>