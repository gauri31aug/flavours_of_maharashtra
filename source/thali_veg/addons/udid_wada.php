...
<br>
<figure>
<img src="udid_wada.jpg" />
<figcaption>Udid Wada</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.25</figcaption>
</figure><br>
<button name="item_name" value="udid_wada">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Soaked vigna mungo are grinded to form a batter and added with fresh coconut pieces, salt and ginger-garlic paste deep fried into small balls. A very healthy and tasty add on often eaten as tea time snack.
</div>
</form>
</body>
</html>