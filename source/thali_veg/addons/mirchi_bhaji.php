...
<br>
<figure>
<img src="mirchi_bhaji.jpg" />
<figcaption>Mirchi Bhaji</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.25</figcaption>
</figure><br>
<button name="item_name" value="mirchi_bhaji">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Less spicy green chillies (bhaji chillies- they are used for making vegetable too; they belong to the capsicum family) stuffed into chickpea flour added with salt and red chilli powder and deep fried. Eaten with chatni/ sauce.
</div>
</form>
</body>
</html>