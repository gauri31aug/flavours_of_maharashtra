...
<br>
<figure>
<img src="paat_wadi.jpg" />
<figcaption>Paat Wadi</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.40</figcaption>
</figure><br>
<button name="item_name" value="paat_wadi">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Gram flour, chopped chillies/ red chilli powder, cumin powder, coriander powder, turmeric, some oil, sesame seeds, asafoetida and salt mixture form a dough; later steamed and cut into thin slices, garnished with coriander leaves.
</div>
</form>
</body>
</html>