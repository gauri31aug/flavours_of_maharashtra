...
<br>
<figure>
<img src="moog_wada.jpg" />
<figcaption>Moog Wada</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.25</figcaption>
</figure><br>
<button name="item_name" value="moog_wada">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Made with soaked green gram grinded added with green chillies, salt and ginger-garlic paste and made into a batter, deep fried into small balls. Taste great with green chutney.
</div>
</form>
</body>
</html>