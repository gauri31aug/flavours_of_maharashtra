...
<br>
<figure>
<img src="kothimbir_wadi.jpg" />
<figcaption>Kothimbir Wadi</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.40</figcaption>
</figure><br>
<button name="item_name" value="kothimbir_wadi">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Gram flour, chopped chillies/ red chilli powder, cumin powder, turmeric, some oil and salt added to lots of chopped coriander leaves to form a dough; later steamed and cut into thin slices deep fried till crisp. A wonderful side dish.
</div>
</form>
</body>
</html>