...
<br>
<figure>
<img src="surali_vadi.jpg" />
<figcaption>Surali Vadi</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.40</figcaption>
</figure><br>
<button name="item_name" value="surali_vadi">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Chickpea flour mixed in buttermilk and steamed then rolled into rolls and tempered with mustard seeds, asafoetida, turmeric garnished with fresh grated coconut and coriander leaves.
</div>
</form>
</body>
</html>