...
<br>
<figure>
<img src="palak_bhaji.jpg" />
<figcaption>Palak Bhaji</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.25</figcaption>
</figure><br>
<button name="item_name" value="palak_bhaji">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Chopped spinach leaves mixed in gram flour added with salt and red chilli powder/green chillies and deep fried. A healthy and tasty add on often eaten as tea time snack.
</div>
</form>
</body>
</html>