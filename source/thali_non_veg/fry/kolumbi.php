...
<button name="item_name" value="kolumbi">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Prawns marinated with fresh green masala- garlic, green chillies or traditional spices, coriander. Coated with semolina and shallow fried.
</div>
</form>
</body>
</html>