...
<br>
<figure>
<img src="anda_kalvan.jpg" />
<figcaption>Anda Kalvan</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.60</figcaption>
</figure><br>
<button name="item_name" value="anda_kalvan">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Simple boiled eggs curry. Dried coconut, red chillies, poppy seeds and whole spices ground to a fine paste and served with boiled sauteed eggs on top. Along with rice or simple chapati this recipe is quite a quick treat!
</div>
</form>
</body>
</html>