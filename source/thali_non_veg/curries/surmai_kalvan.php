...
<br>
<figure>
<img src="surmai_kalvan.jpg" />
<figcaption>Surmai Kalvan</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.60</figcaption>
</figure><br>
<button name="item_name" value="surmai_kalvan">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">A mouth watering sea food usually eaten with breads/rice in the coastal areas. Cooked with grinded ingredients: grated fresh coconut, garlic, coriander and typical spices. Contains Indo Pacific king mackeral/ seer fish as the main stuff.
</div>
</form>
</body>
</html>