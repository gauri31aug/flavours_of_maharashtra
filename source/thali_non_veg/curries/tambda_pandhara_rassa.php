...
<html>
<head>
<title>tambda_pandhara_rassa</title>
...
<br>
<figure>
<img src="tambda_pandhara_rassa.jpg" />
<figcaption>Kolhapuri Tambda Pandhara Rassa</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.60</figcaption>
</figure><br>
<button name="item_name" value="tambda_pandhara_rassa">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Pandhara rassa, meaning white curry, is a soup like dish made from chicken stock, spices such as cinnamon, coriander, ginger, garlic and coconut milk. It is used as a starter and also has medicinal uses for cough and throat ailments. Tambda rassa meaning red curry dish made from chicken stock added with grated dried coconut, onions, ginger-garlic paste, coriander and traditional spices.
</div>
</form>
</body>
</html>