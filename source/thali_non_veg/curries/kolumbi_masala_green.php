...
<html>
<head>
<title>kolumbi_masala_green</title>
...
<br>
<figure>
<img src="kolumbi_masala_green.jpg" />
<figcaption>Hirva Kolumbi Masala</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.60</figcaption>
</figure><br>
<button name="item_name" value="kolumbi_masala_green">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">A delicious thick gravy of prawns cooked with ginger-garlic paste, green chillies, onion and tomatoes and a lots of coriander to give it its unique green colour.
</div>
</form>
</body>
</html>