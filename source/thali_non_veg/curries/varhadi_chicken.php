...
<br>
<figure>
<img src="varhadi_chicken.jpg" />
<figcaption>Varhadi Chicken</figcaption>
<figcaption>1 plate</figcaption>
<figcaption>Rs.60</figcaption>
</figure><br>
<button name="item_name" value="varhadi_chicken">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">A hot and spicy chicken curry from vidarbha (eastern region of Maharashtra). Made from grated dried coconut, onions, ginger-garlic paste, coriander and traditional spices.
</div>
</form>
</body>
</html>