...
<button name="item_name" value="rawas_kalvan">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">A mouth watering sea food usually eaten with breads/rice in the coastal areas. Cooked with grinded ingredients: grated fresh coconut, garlic, coriander and typical spices. Contains Indian Salmon fish as the main stuff.
</div>
</form>
</body>
</html>