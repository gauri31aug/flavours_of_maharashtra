...
<br>
<figure>
<img src="kokum_sarbat.jpg" />
<figcaption>Kokum Sarbat</figcaption>
<figcaption>1 glass</figcaption>
<figcaption>Rs.25</figcaption>
</figure><br>
<button name="item_name" value="kokum_sarbat">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">An awesome appetizer and one of the most refreshing drink on earth! Keeps you cool and beat’s heat. Have a glass of Kokam sarbat to keep heat at bay. Kokam is known as Garcinia Indica- a deep purple colored fruit which gives a tangy flavor and is used as a spice in lot of Indian Cuisines, specially in Goan and Malvani Cuisines. Kokam has lot of benefits and a good antioxidant though. It’s good for digestive system and also known to relieve from acidity and other gastric problems. 
</div>
</form>
</body>
</html>