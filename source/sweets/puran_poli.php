...
<br>
<figure>
<img src="puran_poli.jpg" />
<figcaption>Puran Poli</figcaption>
<figcaption>2 pcs</figcaption>
<figcaption>Rs.60</figcaption>
</figure><br>
<button name="item_name" value="puran_poli">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Sweet flatbread made from chana dal or split yellow gram, plain flour, jaggery or sugar, cardamom powder and nutmeg powder, ghee and water. Usually eaten with ghee or milk or a curry prepared from the stock which is formed by boiling the gram (a step in preparing puran poli). Served during festivals and special occassions.
</div>
</form>
</body>
</html>