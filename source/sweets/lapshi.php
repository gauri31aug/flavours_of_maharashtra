...
<button name="item_name" value="lapshi">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Lapshi means cracked wheat. This special dish is a cracked wheat pudding and traditionally, the sweet ingredient used is jaggery. The mixture of cracked wheat and jaggery is cooked in half milk and half water, flavored by ghee(clarified butter), cardamom and finally garnished with raisins and slices of dry coconut. A very healthy, nutritious and delicious dessert.
</div>
</form>
</body>
</html>