...
<button name="item_name" value="basundi">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Very famous dessert. It is a sweetened dense milk made by boiling milk on low heat until the milk is reduced by half. Dry fruits saffron are added for flavours.
</div>
</form>
</body>
</html>