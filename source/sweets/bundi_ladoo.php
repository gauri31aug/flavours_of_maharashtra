...
<br>
<figure>
<img src="bundi_ladoo.jpg" />
<figcaption>Bundi Ladoo</figcaption>
<figcaption>2 pcs</figcaption>
<figcaption>Rs.40</figcaption>
</figure><br>
<button name="item_name" value="bundi_ladoo">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Delicious sweet made from besan/gram flour batter. The batter is dropped into tiny droplets called 'bundi', deep fried in ghee or oil and later soaked in sugar syrup, thats why the name 'bundi ladoo'. These droplets are then tightly held together to form a ball shaped ladoo. Often garnished with dry fruits mixture. Commonly enjoyed during special occassions and festivals.
</div>
</form>
</body>
</html>