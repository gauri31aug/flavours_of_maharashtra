...
<br>
<figure>
<img src="gulabjaam.jpg" />
<figcaption>Gulabjaam</figcaption>
<figcaption>2 pcs</figcaption>
<figcaption>Rs.30</figcaption>
</figure><br>
<button name="item_name" value="gulabjaam">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Made mainly from milk solids, traditionally from freshly curdled milk deep fried in ghee or oil in ball shapes. These are then soaked in sugar syrup until soft. Often garnished with dried nuts to enhance flavour. Cloves are added to the sugar syrup for flavouring.
</div>
</form>
</body>
</html>