...
<br>
<figure>
<img src="sabudana_kheer.jpg" />
<figcaption>Sabudana Kheer</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.30</figcaption>
</figure><br>
<button name="item_name" value="sabudana_kheer">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Traditional sweet  made from small size sago pearls, milk and sugar. Flavoured with cardamom and nutmeg powder and garnished with crushed dry fruits.
</div>
</form>
</body>
</html>