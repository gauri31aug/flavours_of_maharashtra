...
<button name="item_name" value="modak">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">A rice dumpling made with coconut & jaggery filling and steamed. Served with ghee (clarified Butter). Special dish served during 'Ganesh Chaturthi', one of the biggest festival of Maharashtra.
</div>
</form>
</body>
</html>