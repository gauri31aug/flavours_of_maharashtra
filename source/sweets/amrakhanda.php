...
<br>
<figure>
<img src="amrakhanda.jpg" />
<figcaption>Amrakhanda</figcaption>
<figcaption>1 bowl</figcaption>
<figcaption>Rs.50</figcaption>
</figure><br>
<button name="item_name" value="amrakhanda">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Amrakhand or mango shrikhand is one of the best tasting, fruit-based, traditional desserts. Shrikhand is basically a Maharashtrian sweet made with strained yogurt or hung curd, powdered sugar and flavored with cardamom and saffron. Amrakhand- mango shrikhand is made by adding ground mango puree to the basic shrikhand recipe.
</div>
</form>
</body>
</html>