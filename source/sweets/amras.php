...
<button name="item_name" value="amras">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Pulp of the tropical fruit Mangoin India. The pulp of a ripe fruit is extracted usually by hand and consumed along with Chapati or puri (Indian wheat breads. At times ghee, milk, cardamom or sunth (dried ginger) or saffron are added to the pulp to enhance its flavour.
</div>
</form>
</body>
</html>