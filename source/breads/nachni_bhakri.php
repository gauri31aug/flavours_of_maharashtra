...
<br>
<figure>
<img src="nachni_bhakri.jpg" />
<figcaption>Nachni Bhakri</figcaption>
<figcaption>2 pcs</figcaption>
<figcaption>Rs.30</figcaption>
</figure><br>
<button name="item_name" value="nachni_bhakri">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Made of ragi (finger millet) flour. means ragi-pancake. Served hot and is eaten along with chutney or vegetables, veg or non veg curries.
</div>
</form>
</body>
</html>