...
<br>
<figure>
<img src="rice_bhakri.jpg" />
<figcaption>Tandul Bhakri</figcaption>
<figcaption>2 pcs</figcaption>
<figcaption>Rs.30</figcaption>
</figure><br>
<button name="item_name" value="rice_bhakri">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Tandalachi bhakri is prepared using rice flour. It is very popular in coastal part of Maharashtra where rice is grown abundantly. It goes really well with non-veg curries like chicken, fish, mutton as well as veg dishes.
</div>
</form>
</body>
</html>