...
<button name="item_name" value="amboli">Add to Cart</button>
<br><br>
<div id="show_descp">What's this?</div>
<div id="hide_descp">Hide</div>
<div id="descp">Is a thick, soft, fluffy pancake made of rice and lentils soaked and ground into a fermented batter. This is a typical regional dish from coastal Maharashtra, usually served with chutney for breakfast. With the addition of multiple meals, it could also make a healthy snack or meal. This recipe uses the healthier alternatives, brown rice and red poha (flattened rice), instead of the refined/polished variants, to increase the fibre and health quotient. Enjoy this Savory Lentil Pancake with High Protein Peanut Chutney or Red Chilli Coconut Chutney or with veg non-veg curries.
</div>
</form>
</body>
</html>